...
categories:
  - Uncategorized
---
I updated the basic example that you can find here: <https://marco.dev/2016/02/23/spring-boot-angularjs-2-typescript-hello-world-tutorial/>
...
<img class="alignnone wp-image-39 size-large" src="{{site.baseurl}}/assets/img/uploads/2016/09/davis_1.png?resize=945%2C221" alt="davis_1" data-recalc-dims="1" />

You can see the result on localhost:8080

<img class="alignnone size-medium wp-image-40" src="{{site.baseurl}}/assets/img/uploads/2016/09/davis_2.png?resize=300%2C141" alt="davis_2" data-recalc-dims="1" />
